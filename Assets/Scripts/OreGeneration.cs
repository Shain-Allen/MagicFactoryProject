...
public class OreGeneration : MonoBehaviour
{
     ...
     */
    public static void LoadChunkOres(GridControl grid, GameObject oreName, int seed, int chunkX, int chunkY)
    {
     ...
     */
    private static void GenerateOresInChunk(GridControl grid, GameObject oreName, int seed, int chunkX, int chunkY, int fromChunkX, int fromChunkY)
    {
        System.Random randGen = new System.Random(seed - GetChunkID(fromChunkX, fromChunkY));
        List<Vector3Int> oreSpawns = GetSpawnLocations(randGen, fromChunkX * chunkSize, fromChunkY * chunkSize);
        ...
        foreach(Vector3Int oreCenter in oreSpawns)
            SpawnVein(grid, oreName, oreCenter, randGen, minX, minX + chunkSize - 1, minY, minY + chunkSize - 1);
    } 
     ...
     */
    private static List<Vector3Int> GetSpawnLocations(System.Random randGen, int minX, int minY)
    {
